...
Disponible: ${this.disponible}`)
    ...
    retirar() {
        ...
        console.log(`El contenido ${this.titulo} ha sido retirado de la plataforma.`)
    }
    //? Método para mostrar el estado de disponibilidad del contenido
    estado() {
        console.log(`El contenido ${this.titulo} está disponible: ${this.disponible}`)
    }
}
...
class Pelicula extends Contenido {
    ...
    duracionFormateada() {
        ...
        console.log(`La duración de la película ${this.titulo} es: ${this.duracion_formateada}.`)
    }
...
class Serie extends Contenido {
    ...
    registrarEpisodios(cantidad) {
        ...
        console.log(`La serie ${this.titulo} tiene ${this.temporadas} temporadas y ${this.episodiosPorTemporada} episodios por temporada.`)
    }
    ...
    totalEpisodios() {
        ...
        console.log(`La serie ${this.titulo} tiene un total de ${total} episodios.`)
        return total;
    }
    ficha() {
        console.log(`Título: ${this.titulo}
